    ...
    <div className="about-modal">
      <div className="about-modal-dialog">
        ...
        <div className="about-modal-dialog-row about-modal-dialog-text">
          <strong>Place | Solana</strong> is an on-chain pixel board for
          everyone to draw by changing colors of pixels.
          <br />
          <br />
          The board is 300x500 pixels wide. In future it might be extended if
          the game attracts enough attention. Service fee to change a pixel is
          0.001 SOL.
          <br />
          <br />
          Welcome to the{" "}
          <a
            ...
            target="_blank"
            href="https://discord.gg/eSvvbHe86R"
          >
            Discord
          </a>{" "}
          with feedback, suggestions and contributions!
        </div>
      ...
      <div
        className="about-modal-fade"
        onClick={() =>
          setAbout((prevState) => ({ ...prevState, showAboutModal: false }))
        }
      />
    </div>
  );
