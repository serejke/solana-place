...
type SetState = React.Dispatch<React.SetStateAction<HighlightedPixel | undefined>>;
type State = [HighlightedPixel | undefined, SetState];
const Context = React.createContext<State | undefined>(undefined);

export function HighlightedPixelProvider({children}: { children: React.ReactNode }) {
